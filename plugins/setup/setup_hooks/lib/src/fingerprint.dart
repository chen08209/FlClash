...
class Fingerprint {
  const Fingerprint(this.hash, {this.inputs = const []});
...
class FingerprintBuilder {
  ...
  List<String> get inputs => List.unmodifiable(_inputs);
  ...
  Fingerprint finishWithInputs() => Fingerprint(finish(), inputs: inputs);
...
List<String> collectPackageInputs(String packageDir) {
