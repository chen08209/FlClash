...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(seconds) => "Подтверждение через ${seconds} с";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "aiMcpAdvanced": MessageLookupByLibrary.simpleMessage(
      "Расширенные инструменты",
    ),
    "aiMcpAdvancedDescription": MessageLookupByLibrary.simpleMessage(
      "Дополнительно: смена режима (правила/глобальный/прямой) или закрытие всех активных соединений. Требуется явное разрешение. Отключение сервиса, смена токена или перезапуск снова блокируют доступ.",
    ),
    "aiMcpChanging": MessageLookupByLibrary.simpleMessage(
      "Обновление сервиса…",
    ),
    "aiMcpCopied": MessageLookupByLibrary.simpleMessage(
      "Конфигурация скопирована. Не раскрывайте токен.",
    ),
    "aiMcpCopyConfig": MessageLookupByLibrary.simpleMessage(
      "Копировать конфигурацию подключения",
    ),
    "aiMcpCountdown": m0,
    "aiMcpEnable": MessageLookupByLibrary.simpleMessage(
      "Включить локальный MCP-сервис",
    ),
    "aiMcpEntryDescription": MessageLookupByLibrary.simpleMessage(
      "Локальный ИИ-клиент с ограниченными правами управления прокси",
    ),
    "aiMcpListenError": MessageLookupByLibrary.simpleMessage(
      "Не удалось открыть локальный порт. Проверьте, не занят ли он.",
    ),
    "aiMcpLocked": MessageLookupByLibrary.simpleMessage("Заблокировано"),
    "aiMcpPort": MessageLookupByLibrary.simpleMessage(
      "Порт (изменение при выключенном сервисе)",
    ),
    "aiMcpPortInvalid": MessageLookupByLibrary.simpleMessage(
    ...
    "aiMcpRunning": MessageLookupByLibrary.simpleMessage(
      "Работает · только 127.0.0.1",
    ),
    "aiMcpSetup": MessageLookupByLibrary.simpleMessage(
      "Подключение ИИ-клиента",
    ),
    "aiMcpSetupDescription": MessageLookupByLibrary.simpleMessage(
      "1. Включите сервис и оставьте FlClash открытым.\n2. В доверенном локальном MCP-клиенте выберите Streamable HTTP (не SSE и не stdio). Используйте URL ниже и заголовок Bearer Authorization из скопированной конфигурации. Формат зависит от клиента.\n3. Вставьте запись mcpServers в настройки клиента и переподключитесь. Токен — это пароль: не передавайте его другим или в облако. При копировании он попадает в системный буфер обмена.\nБазовые инструменты: состояние, видимые группы и узлы, выбор существующего узла и проверка задержки до 8 узлов с URL из настроек приложения. Имена — недоверенные данные. Браузеры, LAN и удалённые клиенты не поддерживаются. Внешний контроллер не нужен.",
    ),
    "aiMcpStopped": MessageLookupByLibrary.simpleMessage(
      "Выключен · при запуске приложения всегда выключен",
    ),
    "aiMcpStorageError": MessageLookupByLibrary.simpleMessage(
      "Не удалось сохранить локальные данные доступа MCP. Сервис выключен.",
    ),
    "aiMcpTitle": MessageLookupByLibrary.simpleMessage("Инструменты AI MCP"),
    "aiMcpUnlock": MessageLookupByLibrary.simpleMessage(
      "Разблокировать расширенные инструменты",
    ),
    "aiMcpUnlockWarning": MessageLookupByLibrary.simpleMessage(
      "ИИ-клиент сможет менять маршрутизацию, обходить прокси в прямом режиме или прервать все соединения. Разрешайте только доверенным клиентам. Подождите 3 секунды и нажмите «Подтвердить». Закрытие окна не даёт доступа.",
    ),
    "aiMcpUnlocked": MessageLookupByLibrary.simpleMessage(
      "Разблокировано до завершения сеанса приложения",
    ),
