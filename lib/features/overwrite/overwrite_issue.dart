...
extension OverwriteIssueExt on OverwriteIssue {
  String getMessage(BuildContext context) {
    ...
    return switch (this) {
      ...
      SubscriptionGroupMissingProxiesIssue(:final names) =>
        appLocalizations.overwriteIssueSubscriptionGroupMissingProxies(
          names.join(', '),
        ),
      ProviderShadowedIssue(:final name) =>
        appLocalizations.overwriteIssueProviderShadowed(name),
    };
  }
}
