...
class CommonAction extends _$CommonAction {
  ...
  Future<void> autoCheckUpdate() async {
    // FlClashPlus uses its own release channel. Do not query the upstream
    // FlClash repository here, otherwise Plus builds receive incompatible
    // upstream release prompts.
  }
