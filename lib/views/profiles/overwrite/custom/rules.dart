      ...
      PagedSheetRoute(
        builder: (context) => Consumer(
          builder: (_, ref, _) {
            ...
            final ownRuleProviders = ruleProviders.toSet();
              ...
              sections: [
                OverwriteSelectionSection(
                  ...
                  subtitleBuilder: (context, item) =>
                      appRuleProviders.contains(item)
                      ? context.appLocalizations.appProviderShadowed
                      : null,
                ),
                if (!ownRuleProviders.containsAll(appRuleProviders))
                  OverwriteSelectionSection(
                    label: context.appLocalizations.appRuleProviders,
                    items: [
                      for (final name in appRuleProviders)
                        if (!ownRuleProviders.contains(name)) name,
                    ],
                  ),
              ],
